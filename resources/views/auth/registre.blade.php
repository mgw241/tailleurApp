...
<body>
    <div class="container" style="margin-top:80px">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <h3 class="card-header text-center">Enrégistrement</h3>
                    <div class="card-body">
                        <form method="POST" action="{{ route('registre') }}">  
                            ...
                            <div class="form-group mb-3"> 
                                <input type="password" placeholder="Confirmer mot de passe" id="confirm_password" class="form-control" name="confirm_password" required>
                            </div> 
